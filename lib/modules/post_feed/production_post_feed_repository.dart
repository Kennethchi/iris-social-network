...
class ProductionPostFeedRepository extends PostFeedRepository{
  ...
  async {
    ...
    return await FirestoreProvider.getPostsData(postType: postType, postQueryType: postQueryType, queryLimit: queryLimit, startAfterMap: startAfterMap);
  }
