...
import 'friends_post_feed_views_widgets.dart';
...
class FriendsPostFeedView extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: CustomScrollView(
        ...
        controller: FriendsPostFeedBlocProvider.of(context).scrollController,
        slivers: <Widget>[

          FriendsPostFeedSliverAppBarView(),
                          ...
                          return Transform.scale(
                            ...
                            child: Card(
                              ...
                              child: Hero(
                                  ...
                                  child: FriendsPostFeedBlocProvider.of(context).handlers.getPostPreviewWidget(
                                      friendsPostFeedContext: context,
